    ...
    <div className="login-page">
      ...
      <form className="login-page__form" onSubmit={handleSubmit}>
        ...
        <div className="login-page__options">
          ...
          <Link to={ROUTES.FORGOT_PASSWORD} className="login-page__forgot">Quên mật khẩu?</Link>
        </div>
      ...
      <div className="login-page__divider"><span>hoặc đăng nhập nhanh với</span></div>
      ...
      <div className="login-page__demo">
        <p className="login-page__demo-title">Đăng nhập nhanh với tài khoản demo:</p>
        <div className="login-page__demo-btns">
      ...
      <p className="login-page__footer">
        Chưa có tài khoản? <Link to={ROUTES.REGISTER} className="login-page__link">Đăng ký ngay</Link>
      </p>
    </div>
  );
};
