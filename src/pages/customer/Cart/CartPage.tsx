    ...
    return (
      <div className="cart-page cart-page--empty">
        <div className="cart-empty">
          ...
          <Link to={ROUTES.LOGIN} className="btn btn-primary btn-lg">Đăng nhập ngay</Link>
          <div style={{ marginTop: '1rem' }}>
            <span style={{ color: 'var(--color-text-muted)' }}>Chưa có tài khoản? </span>
            <Link to={ROUTES.REGISTER} style={{ color: 'var(--color-primary)', fontWeight: 600 }}>Đăng ký</Link>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="cart-page">
      <div className="container">
        <h1 className="cart-page__title">Giỏ hàng ({selectedTotalQty} sản phẩm)</h1>
          ...
          <div className="cart-page__summary">
            <div className="cart-summary card">
              ...
              <div className="cart-summary__row">
                <span>Tạm tính ({selectedTotalQty} sản phẩm)</span>
              ...
              <button
                ...
                disabled={selectedTotalQty === 0}
                onClick={() => navigate(ROUTES.CHECKOUT)}
              >
                Tiến hành đặt hàng ({selectedTotalQty})
              </button>
